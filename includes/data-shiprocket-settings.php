    ...
    <script>
        window.addEventListener('load', function () {
            ...
            jQuery("#shiprocket_get_account_details").click(function () {
                ...
                data.shipping_address_2 = "<?php ob_start(); echo $user_meta['shipping_address_2'][0] ?? '' ?>";
...
return array(
    ...
    'zone_wise_enabled' =>  array(
        ...
        <br/><b>Note</b>: Create a Default Zone and add <b>Shiprocket App Configuration</b> shipping method to support Shiprocket Shipping by <b>default</b>", 'shiprocket-woocommerce-shipping-calculator'),
        'default' => 'no',
    )
);